...
function AddBusModal({onClose}) {
    ...
    async function handleSubmit(e) {
        e.preventDefault()
        let response = await axios.post('http://localhost:8080/addBus',form,{
            headers:{
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-md">
                ...
                <form className="space-y-4">
                    ...
                    <div className="flex justify-end space-x-2">
                        ...
                        <button onClick={(e)=>{handleSubmit(e)}} className="btn-primary">Add</button>
                    </div>
                </form>
            </div>
        </div>
